...
(function (pixi_js) {
            ...
            ***************************************************************************** */
            ...
            var MediaElementLoadStrategy = (function (_super) {
                __extends$5(MediaElementLoadStrategy, _super);
            ...
            var AudioLoadStrategy = (function (_super) {
                __extends$5(AudioLoadStrategy, _super);
            ...
            var ImageLoadStrategy = (function (_super) {
                __extends$5(ImageLoadStrategy, _super);
            ...
            var VideoLoadStrategy = (function (_super) {
                __extends$5(VideoLoadStrategy, _super);
            ...
            var XhrLoadStrategy = (function (_super) {
                __extends$5(XhrLoadStrategy, _super);
            ...
            ***************************************************************************** */
            ...
            var funcProto$2 = Function.prototype,
                objectProto$9$1 = Object.prototype;
            ...
            var reIsNative$1 = RegExp('^' +
              funcToString$2.call(hasOwnProperty$7$1).replace(reRegExpChar$1, '\\$&')
            ...
            /** Built-in value references. */
            var Buffer$1 = moduleExports$1$1 ? root$1.Buffer : undefined;
            ...
            typedArrayTags$1[dataViewTag$1$1] = typedArrayTags$1[dateTag$2] =
            typedArrayTags$1[errorTag$2] = typedArrayTags$1[funcTag$2] =
            typedArrayTags$1[mapTag$1$1] = typedArrayTags$1[numberTag$2] =
            typedArrayTags$1[objectTag$2$1] = typedArrayTags$1[regexpTag$2] =
            typedArrayTags$1[setTag$1$1] = typedArrayTags$1[stringTag$2] =
            ...
            function arrayLikeKeys$1(value, inherited) {
              ...
              for (var key in value) {
                if ((inherited || hasOwnProperty$3$1.call(value, key)) &&
                    !(skipIndexes && (
            ...
            function isPrototype$1(value) {
              var Ctor = value && value.constructor,
                  proto = (typeof Ctor == 'function' && Ctor.prototype) || objectProto$3$1;
            ...
            if ((DataView$1 && getTag$2(new DataView$1(new ArrayBuffer(1))) != dataViewTag$3) ||
                (Map$1 && getTag$2(new Map$1) != mapTag$3) ||
                (Promise$1$1 && getTag$2(Promise$1$1.resolve()) != promiseTag$1) ||
                (Set$1$1 && getTag$2(new Set$1$1) != setTag$3) ||
                (WeakMap$1 && getTag$2(new WeakMap$1) != weakMapTag$2)) {
            ...
            function baseIsEqualDeep$1(object, other, bitmask, customizer, equalFunc, stack) {
              var objIsArr = isArray$1(object),
                  ...
                  objTag = objIsArr ? arrayTag$2 : getTag$1$1(object),
                  othTag = othIsArr ? arrayTag$2 : getTag$1$1(other);
            ...
            function defineProperty(_a) {
                ...
                if (prop.deep && isObject$1(obj[key])) {
                    try {
                        for (var _c = __values$1(Object.keys(obj[key])), _d = _c.next(); !_d.done; _d = _c.next()) {
            ...
            function initObserver(Systems) {
                ...
                if (Systems instanceof Array) {
                    Ss.push.apply(Ss, __spread$1(Systems));
                }
                else {
                    Ss.push(Systems);
                }
                try {
                    for (var Ss_1 = __values$1(Ss), Ss_1_1 = Ss_1.next(); !Ss_1_1.done; Ss_1_1 = Ss_1.next()) {
                        var S = Ss_1_1.value;
                        for (var componentName in S.observerInfo) {
                            ...
                            try {
                                for (var _c = (e_3 = void 0, __values$1(S.observerInfo[componentName])), _d = _c.next(); !_d.done; _d = _c.next()) {
                                    var prop = _d.value;
                                    _loop_1(prop);
                                }
                            }
            ...
            function observer(component, componentName) {
                ...
                try {
                    for (var _b = __values$1(componentProps[componentName]), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var item = _c.value;
            ...
            var Transform$1 = /** @class */ (function (_super) {
                __extends$4(Transform, _super);
                function Transform() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
            ...
            var GameObject = /** @class */ (function () {
                ...
                Object.defineProperty(GameObject.prototype, "transform", {
                     ...
                     */
                    get: function () {
                        return this.getComponent(Transform$1.componentName);
                    },
                    enumerable: false,
                    configurable: true
                });
                ...
                Object.defineProperty(GameObject.prototype, "scene", {
                    ...
                    set: function (val) {
                        ...
                        if (this.transform && this.transform.children) {
                            try {
                                for (var _b = __values$1(this.transform.children), _c = _b.next(); !_c.done; _c = _b.next()) {
                                    var child = _c.value;
            ...
            var Ticker = /** @class */ (function () {
                ...
                Ticker.prototype.update = function () {
                    ...
                    if (time - this._lastTime >= this._frameDuration) {
                        ...
                        try {
                            for (var _b = __values$1(this._tickers), _c = _b.next(); !_c.done; _c = _b.next()) {
                                var func = _c.value;
            ...
            var getAllGameObjects = function (game) {
                ...
                try {
                    for (var gameObjectsArray_1 = __values$1(gameObjectsArray), gameObjectsArray_1_1 = gameObjectsArray_1.next(); !gameObjectsArray_1_1.done; gameObjectsArray_1_1 = gameObjectsArray_1.next()) {
                        var gameObjects = gameObjectsArray_1_1.value;
                        otherSceneGameObjects = __spread$1(otherSceneGameObjects, gameObjects);
                    }
                }
                catch (e_1_1) { e_1 = { error: e_1_1 }; }
                finally {
                ...
                return __spread$1(mainSceneGameObjects, otherSceneGameObjects);
            };
            var gameObjectLoop = function (e, gameObjects) {
                var e_2, _a, e_3, _b, e_4, _c, e_5, _d;
                if (gameObjects === void 0) { gameObjects = []; }
                try {
                    for (var gameObjects_1 = __values$1(gameObjects), gameObjects_1_1 = gameObjects_1.next(); !gameObjects_1_1.done; gameObjects_1_1 = gameObjects_1.next()) {
                        var gameObject = gameObjects_1_1.value;
                        try {
                            for (var _e = (e_3 = void 0, __values$1(gameObject.components)), _f = _e.next(); !_f.done; _f = _e.next()) {
                ...
                try {
                    for (var gameObjects_2 = __values$1(gameObjects), gameObjects_2_1 = gameObjects_2.next(); !gameObjects_2_1.done; gameObjects_2_1 = gameObjects_2.next()) {
                        var gameObject = gameObjects_2_1.value;
                        try {
                            for (var _g = (e_5 = void 0, __values$1(gameObject.components)), _h = _g.next(); !_h.done; _h = _g.next()) {
            ...
            var gameObjectResume = function (gameObjects) {
                var e_6, _a, e_7, _b;
                try {
                    for (var gameObjects_3 = __values$1(gameObjects), gameObjects_3_1 = gameObjects_3.next(); !gameObjects_3_1.done; gameObjects_3_1 = gameObjects_3.next()) {
                        var gameObject = gameObjects_3_1.value;
                        try {
                            for (var _c = (e_7 = void 0, __values$1(gameObject.components)), _d = _c.next(); !_d.done; _d = _c.next()) {
            ...
            var gameObjectPause = function (gameObjects) {
                var e_8, _a, e_9, _b;
                try {
                    for (var gameObjects_4 = __values$1(gameObjects), gameObjects_4_1 = gameObjects_4.next(); !gameObjects_4_1.done; gameObjects_4_1 = gameObjects_4.next()) {
                        var gameObject = gameObjects_4_1.value;
                        try {
                            for (var _c = (e_9 = void 0, __values$1(gameObject.components)), _d = _c.next(); !_d.done; _d = _c.next()) {
                                var component = _d.value;
                                try {
            ...
            var Game = /** @class */ (function (_super) {
                ...
                function Game(_a) {
                    ...
                    if (systems && systems.length) {
                        try {
                            for (var systems_1 = __values$1(systems), systems_1_1 = systems_1.next(); !systems_1_1.done; systems_1_1 = systems_1.next()) {
                ...
                Game.prototype.initTicker = function () {
                    ...
                    this.ticker.add(function (e) {
                        ...
                        try {
                            for (var _c = __values$1(_this.systems), _d = _c.next(); !_d.done; _d = _c.next()) {
                                var system = _d.value;
                                try {
                                    triggerStart(system);
                        ...
                        try {
                            for (var _e = __values$1(_this.systems), _f = _e.next(); !_f.done; _f = _e.next()) {
                                var system = _f.value;
                                try {
                ...
                Game.prototype.triggerResume = function () {
                    ...
                    try {
                        for (var _b = __values$1(this.systems), _c = _b.next(); !_c.done; _c = _b.next()) {
                            var system = _c.value;
                            try {
            ...
            var Resource = /** @class */ (function (_super) {
                ...
                Resource.prototype.addResource = function (resources) {
                    ...
                    try {
                        for (var resources_1 = __values$1(resources), resources_1_1 = resources_1.next(); !resources_1_1.done; resources_1_1 = resources_1.next()) {
            ...
            ***************************************************************************** */
            ...
            var Application = /** @class */ (function (_super) {
                __extends$3(Application, _super);
            ...
            ***************************************************************************** */
            ...
            var Text = /** @class */ (function (_super) {
                ...
                Text.prototype.init = function () {
                    this.renderSystem = this.game.getSystem(Renderer$1);
            ...
            ***************************************************************************** */
            ...
            var DemoSystem = /** @class */ (function (_super) {
