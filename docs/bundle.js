...
(function (pixi_js) {
	...
	***************************************************************************** */
	...
	var MediaElementLoadStrategy = (function (_super) {
	    __extends$6(MediaElementLoadStrategy, _super);
	...
	var AudioLoadStrategy = (function (_super) {
	    __extends$6(AudioLoadStrategy, _super);
	...
	var ImageLoadStrategy = (function (_super) {
	    __extends$6(ImageLoadStrategy, _super);
	...
	var VideoLoadStrategy = (function (_super) {
	    __extends$6(VideoLoadStrategy, _super);
	...
	var XhrLoadStrategy = (function (_super) {
	    __extends$6(XhrLoadStrategy, _super);
	...
	***************************************************************************** */
	...
	function defineProperty(_a) {
	  ...
	  if (prop.deep && isObject(obj[key])) {
	    try {
	      for (var _c = __values$2(Object.keys(obj[key])), _d = _c.next(); !_d.done; _d = _c.next()) {
	...
	function initObserver(Systems) {
	  ...
	  if (Systems instanceof Array) {
	    Ss.push.apply(Ss, __spread$2(Systems));
	  } else {
	    Ss.push(Systems);
	  }
	  try {
	    for (var Ss_1 = __values$2(Ss), Ss_1_1 = Ss_1.next(); !Ss_1_1.done; Ss_1_1 = Ss_1.next()) {
	      var S = Ss_1_1.value;
	      for (var componentName in S.observerInfo) {
	        ...
	        try {
	          for (
	            var _c = ((e_3 = void 0), __values$2(S.observerInfo[componentName])), _d = _c.next();
	            !_d.done;
	            _d = _c.next()
	          ) {
	            var prop = _d.value;
	...
	function observer(component, componentName) {
	  ...
	  try {
	    for (var _b = __values$2(componentProps[componentName]), _c = _b.next(); !_c.done; _c = _b.next()) {
	      var item = _c.value;
	...
	var Transform$2 = (function (_super) {
	  __extends$5(Transform, _super);
	  function Transform() {
	    var _this = (_super !== null && _super.apply(this, arguments)) || this;
	  ...
	  __decorate$3([IDEProp], Transform.prototype, 'position', void 0);
	  __decorate$3([IDEProp], Transform.prototype, 'size', void 0);
	  __decorate$3([IDEProp], Transform.prototype, 'origin', void 0);
	  __decorate$3([IDEProp], Transform.prototype, 'anchor', void 0);
	  __decorate$3([IDEProp], Transform.prototype, 'scale', void 0);
	  __decorate$3([IDEProp], Transform.prototype, 'skew', void 0);
	  __decorate$3([IDEProp], Transform.prototype, 'rotation', void 0);
	  return Transform;
	})(Component$1);
	var Transform$1$1 = Transform$2;
	...
	var GameObject = (function () {
	  function GameObject(name, obj) {
	    ...
	    this._name = name;
	    this.id = getId();
	    this.addComponent(Transform$1$1, obj);
	  }
	  Object.defineProperty(GameObject.prototype, 'transform', {
	    get: function () {
	      return this.getComponent(Transform$1$1);
	    },
	    enumerable: false,
	    configurable: true,
	  });
	  ...
	  Object.defineProperty(GameObject.prototype, 'scene', {
	    ...
	    set: function (val) {
	      ...
	      if (this.transform && this.transform.children) {
	        try {
	          for (var _b = __values$2(this.transform.children), _c = _b.next(); !_c.done; _c = _b.next()) {
	            var child = _c.value;
	...
	var Ticker = (function () {
	  ...
	  Ticker.prototype.update = function () {
	    ...
	    if (durationTime >= this._frameDuration) {
	      ...
	      try {
	        for (var _b = __values$2(this._tickers), _c = _b.next(); !_c.done; _c = _b.next()) {
	          var func = _c.value;
	...
	var getAllGameObjects = function (game) {
	  var e_1, _a;
	  var _b;
	  var mainSceneGameObjects =
	    ((_b = game === null || game === void 0 ? void 0 : game.scene) === null || _b === void 0
	      ? void 0
	      : _b.gameObjects) || [];
	  var gameObjectsArray =
	    game === null || game === void 0
	      ? void 0
	      : game.multiScenes.map(function (_a) {
	  ...
	  try {
	    for (
	      var gameObjectsArray_1 = __values$2(gameObjectsArray), gameObjectsArray_1_1 = gameObjectsArray_1.next();
	      !gameObjectsArray_1_1.done;
	      gameObjectsArray_1_1 = gameObjectsArray_1.next()
	    ) {
	      var gameObjects = gameObjectsArray_1_1.value;
	      otherSceneGameObjects = __spread$2(otherSceneGameObjects, gameObjects);
	    }
	  } catch (e_1_1) {
	    e_1 = { error: e_1_1 };
	  } finally {
	    try {
	      if (gameObjectsArray_1_1 && !gameObjectsArray_1_1.done && (_a = gameObjectsArray_1.return))
	        _a.call(gameObjectsArray_1);
	    } finally {
	      if (e_1) throw e_1.error;
	    }
	  }
	  return __spread$2(mainSceneGameObjects, otherSceneGameObjects);
	};
	var gameObjectLoop = function (e, gameObjects) {
	  ...
	  try {
	    for (
	      var gameObjects_1 = __values$2(gameObjects), gameObjects_1_1 = gameObjects_1.next();
	      !gameObjects_1_1.done;
	      gameObjects_1_1 = gameObjects_1.next()
	    ) {
	      var gameObject = gameObjects_1_1.value;
	      try {
	        for (var _e = ((e_3 = void 0), __values$2(gameObject.components)), _f = _e.next(); !_f.done; _f = _e.next()) {
	  ...
	  try {
	    for (
	      var gameObjects_2 = __values$2(gameObjects), gameObjects_2_1 = gameObjects_2.next();
	      !gameObjects_2_1.done;
	      gameObjects_2_1 = gameObjects_2.next()
	    ) {
	      var gameObject = gameObjects_2_1.value;
	      try {
	        for (var _g = ((e_5 = void 0), __values$2(gameObject.components)), _h = _g.next(); !_h.done; _h = _g.next()) {
	...
	var gameObjectResume = function (gameObjects) {
	  ...
	  try {
	    for (
	      var gameObjects_3 = __values$2(gameObjects), gameObjects_3_1 = gameObjects_3.next();
	      !gameObjects_3_1.done;
	      gameObjects_3_1 = gameObjects_3.next()
	    ) {
	      var gameObject = gameObjects_3_1.value;
	      try {
	        for (var _c = ((e_7 = void 0), __values$2(gameObject.components)), _d = _c.next(); !_d.done; _d = _c.next()) {
	...
	var gameObjectPause = function (gameObjects) {
	  ...
	  try {
	    for (
	      var gameObjects_4 = __values$2(gameObjects), gameObjects_4_1 = gameObjects_4.next();
	      !gameObjects_4_1.done;
	      gameObjects_4_1 = gameObjects_4.next()
	    ) {
	      var gameObject = gameObjects_4_1.value;
	      try {
	        for (var _c = ((e_9 = void 0), __values$2(gameObject.components)), _d = _c.next(); !_d.done; _d = _c.next()) {
	          var component = _d.value;
	          try {
	...
	var Game = (function (_super) {
	  ...
	  function Game(_a) {
	    ...
	    if (systems && systems.length) {
	      try {
	        for (
	          var systems_1 = __values$2(systems), systems_1_1 = systems_1.next();
	          !systems_1_1.done;
	  ...
	  Game.prototype.initTicker = function () {
	    ...
	    this.ticker.add(function (e) {
	      ...
	      try {
	        for (var _c = __values$2(_this.systems), _d = _c.next(); !_d.done; _d = _c.next()) {
	          var system = _d.value;
	          try {
	            triggerStart(system);
	      ...
	      try {
	        for (var _e = __values$2(_this.systems), _f = _e.next(); !_f.done; _f = _e.next()) {
	          var system = _f.value;
	          try {
	  ...
	  Game.prototype.triggerResume = function () {
	    ...
	    try {
	      for (var _b = __values$2(this.systems), _c = _b.next(); !_c.done; _c = _b.next()) {
	        var system = _c.value;
	        try {
	  ...
	  Game.prototype.destroySystems = function () {
	    var e_15, _a;
	    try {
	      for (var _b = __values$2(__spread$2(this.systems)), _c = _b.next(); !_c.done; _c = _b.next()) {
	        var system = _c.value;
	...
	var Resource = (function (_super) {
	  ...
	  Resource.prototype.addResource = function (resources) {
	    ...
	    try {
	      for (
	        var resources_1 = __values$2(resources), resources_1_1 = resources_1.next();
	        !resources_1_1.done;
	...
	***************************************************************************** */
	...
	var Application = (function (_super) {
	  __extends$4(Application, _super);
	...
	***************************************************************************** */
	...
	var RendererManager = (function () {
	  ...
	  RendererManager.prototype.register = function () {
	    ...
	    try {
	      for (
	        var renderers_1 = __values$1(renderers), renderers_1_1 = renderers_1.next();
	        !renderers_1_1.done;
	        renderers_1_1 = renderers_1.next()
	      ) {
	  ...
	  RendererManager.prototype.componentChanged = function (changes) {
	    ...
	    var _loop_1 = function (changed) {
	      var e_3, _a;
	      try {
	        for (var _b = ((e_3 = void 0), __values$1(this_1.renderers)), _c = _b.next(); !_c.done; _c = _b.next()) {
	          var renderer = _c.value;
	          var props = renderer.observerInfo[changed.componentName];
	          if (props) {
	            if ([ObserverType.ADD, ObserverType.REMOVE].indexOf(changed.type) > -1) {
	              try {
	            ...
	            if (index > -1) {
	              try {
	                ...
	                console.error(
	                  'gameObject: ' +
	                    (changed.gameObject && changed.gameObject.name) +
	                    ', ' +
	    ...
	    try {
	      for (
	        var changes_1 = __values$1(changes), changes_1_1 = changes_1.next();
	        !changes_1_1.done;
	  ...
	  RendererManager.prototype.update = function (gameObject) {
	    var e_4, _a, e_5, _b;
	    try {
	      for (var _c = __values$1(gameObject.components), _d = _c.next(); !_d.done; _d = _c.next()) {
	        var component = _d.value;
	        try {
	          for (var _e = ((e_5 = void 0), __values$1(this.renderers)), _f = _e.next(); !_f.done; _f = _e.next()) {
	...
	var Transform = (function (_super) {
	  ...
	  Transform.prototype.update = function () {
	    var e_1, _a, e_2, _b;
	    try {
	      for (var _c = __values$1(this.waitRemoveIds), _d = _c.next(); !_d.done; _d = _c.next()) {
	        var id = _d.value;
	    ...
	    this.waitRemoveIds = [];
	    try {
	      for (var _e = __values$1(this.waitChangeScenes), _f = _e.next(); !_f.done; _f = _e.next()) {
	  ...
	  Transform.prototype.componentChanged = function (changed) {
	    if (changed.type === ObserverType.ADD) {
	      this.addContainer(changed);
	    } else if (changed.type === ObserverType.CHANGE) {
	      this.change(changed);
	    } else if (changed.type === ObserverType.REMOVE) {
	  ...
	  Transform.prototype.change = function (changed) {
	    ...
	    if (transform.parent) {
	      ...
	      var render =
	        changed.gameObject.transform.parent && changed.gameObject.transform.parent.gameObject.getComponent('Render');
	      if (render) {
	...
	var Renderer$2 = (function (_super) {
	  ...
	  Renderer.prototype.registerObserver = function (observerInfo) {
	    ...
	    for (var key in observerInfo) {
	      ...
	      (_a = thisObserverInfo[key]).push.apply(_a, __spread$1(observerInfo[key]));
	    }
	  };
	  ...
	  Renderer.prototype.createApplication = function (params) {
	    ...
	    var app = new Application$1(__assign$1({ sharedTicker: true }, params));
	  ...
	  Renderer.prototype.update = function () {
	    ...
	    try {
	      for (var _c = __values$1(this.game.gameObjects), _d = _c.next(); !_d.done; _d = _c.next()) {
	  ...
	  Renderer.prototype.onDestroy = function () {
	    ...
	    try {
	      for (var _b = __values$1(this.multiApps), _c = _b.next(); !_c.done; _c = _b.next()) {
	        var app = _c.value;
	        app && app.destroy();
	      }
	    } catch (e_3_1) {
	...
	***************************************************************************** */
	...
	var Event$2 = (function (_super) {
	  ...
	  Event.prototype.init = function (_a) {
	    ...
	    this.renderSystem = this.game.getSystem(Renderer$3);
	  ...
	  Event.prototype.componentChanged = function (changed) {
	    switch (changed.type) {
	      case ObserverType.ADD:
	        this.add(changed);
	        break;
	      case ObserverType.REMOVE:
	        this.remove(changed);
	        break;
	...
	***************************************************************************** */
	...
	var Img$2 = (function (_super) {
	  ...
	  __decorate([decorators.IDEProp], Img.prototype, 'resource', void 0);
	  return Img;
	})(Component$1);
	var Img$3 = Img$2;
	      ...
	      return __generator(this, function (_a) {
	        switch (_a.label) {
	          case 0:
	            ...
	            if (!(changed.type === ObserverType.ADD)) return [3, 1];
	            sprite_1 = new Sprite$1(null);
	            ...
	            return [3, 4];
	          case 1:
	            if (!(changed.type === ObserverType.CHANGE)) return [3, 3];
	          ...
	          case 2:
	            ...
	            return [3, 4];
	          case 3:
	            if (changed.type === ObserverType.REMOVE) {
	...
	***************************************************************************** */
	...
	var JOYSTICK_EVENT;
	(function (JOYSTICK_EVENT) {
	    JOYSTICK_EVENT["Begin"] = "Begin";
	    JOYSTICK_EVENT["Drag"] = "Drag";
	    JOYSTICK_EVENT["End"] = "End";
	...
	var Joystick = /** @class */ (function (_super) {
	    ...
	    function Joystick() {
	        var _this = _super !== null && _super.apply(this, arguments) || this;
	        _this.name = 'Joystick';
	        _this.limitRadius = 70;
	        _this.boxImageResource = '_Joystick_box';
	        _this.boxRadius = 100;
	        _this.btnImageResource = '_Joystick_btn';
	        _this.btnRadius = 20;
	        _this.followPointer = { open: false };
	        _this.vector2 = { x: 0, y: 0 };
	        _this.basePosition = { x: 0, y: 0 };
	        _this.moving = false;
	    ...
	    Joystick.prototype.bindTouch = function () {
	        ...
	        this.evt.on('touchmove', function (e) {
	            ...
	            vector2.x = (position.x - _this.basePosition.x) / _this.limitRadius;
	            vector2.y = (position.y - _this.basePosition.y) / _this.limitRadius;
	            var vector2Pow = {
	                x: Math.pow(vector2.x, 2),
	                y: Math.pow(vector2.y, 2),
	            };
	            if (vector2Pow.x + vector2Pow.y > 1) {
	                var sqrt = Math.sqrt(vector2Pow.x + vector2Pow.y);
	                vector2.x /= sqrt;
	                vector2.y /= sqrt;
	            }
	        });
	        var touchend = function (e) {
	            ...
	            _this.vector2.x = 0;
	            _this.vector2.y = 0;
	            _this.triggerTouchend = true;
	        };
	        this.evt.on('touchend', touchend);
	        this.evt.on('touchendoutside', touchend);
	    };
	    Joystick.prototype.createGO = function (name, resource, radius, parent) {
	        var go = new GameObject$1('Joystick_' + name, {
	            size: {
	                width: radius * 2,
	                height: radius * 2,
	            },
	        ...
	        go.addComponent(new Img$3({
	            resource: resource
	        }));
	        (parent || this.gameObject).addChild(go);
	        return go;
	    };
	    Joystick.prototype.createFollowPointer = function () {
	        var _this = this;
	        if (!this.followPointer.open)
	            return;
	        this.evt.on('touchstart', function (_a) {
	            var data = _a.data;
	            _this.gameObject.transform.position.x = data.position.x;
	            _this.gameObject.transform.position.y = data.position.y;
	        });
	    };
	    Joystick.prototype.initResource = function (params) {
	    ...
	    Joystick.componentName = 'Joystick';
	    return Joystick;
	}(Component$1));
	...
	joystick.on(JOYSTICK_EVENT.Begin, function (data) {
